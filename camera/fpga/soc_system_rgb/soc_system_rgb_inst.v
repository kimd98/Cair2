	soc_system_rgb u0 (
		...
		.gray_img_data_valid                   (<connected-to-gray_img_data_valid>),                   //               gray_img.data_valid
		.gray_img_input_data                   (<connected-to-gray_img_input_data>),                   //                       .input_data
		.gray_img_img_width                    (<connected-to-gray_img_img_width>),                    //                       .img_width
		.gray_img_img_height                   (<connected-to-gray_img_img_height>),                   //                       .img_height
		.gray_stream_reset_n_reset_n           (<connected-to-gray_stream_reset_n_reset_n>),           //    gray_stream_reset_n.reset_n
		...
		.img_processing_hue_thres_l            (<connected-to-img_processing_hue_thres_l>),            //         img_processing.hue_thres_l
		.img_processing_hue_thres_h            (<connected-to-img_processing_hue_thres_h>),            //                       .hue_thres_h
		.img_processing_bri_thres_l            (<connected-to-img_processing_bri_thres_l>),            //                       .bri_thres_l
		.img_processing_sat_thres_l            (<connected-to-img_processing_sat_thres_l>),            //                       .sat_thres_l
		.img_processing_bri_thres_h            (<connected-to-img_processing_bri_thres_h>),            //                       .bri_thres_h
		.img_processing_sat_thres_h            (<connected-to-img_processing_sat_thres_h>),            //                       .sat_thres_h
